...
class Task {
 ...
 private:
  ...
  // Hyprland workspace ID for this window.
  int64_t workspace_id_ = -1;
 ...
 public:
  ...
  int64_t workspace_id() const { return workspace_id_; }

  void set_workspace_id(int64_t id) { workspace_id_ = id; }
 ...
 public:
  /* Workspace filtering */
  void set_workspace_visible(bool visible);
...
class Taskbar : public waybar::AModule {
 ...
 private:
  ...
  // Hyprland workspace filtering.
  int64_t current_workspace_id_ = -1;
  sigc::connection workspace_timer_;
